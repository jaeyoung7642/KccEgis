				...
				<div class="ly_inner xsm">
					...
					<article class="bl_card findaccount_card m_full">
						<div class="member_inner">
							<div class="member_header no_line">
								<p class="mb_heading">아이디 찾기</p>
							</div> 
							<p class="mb_msg">회원님의 아이디는 <strong class="txt_point">${id}</strong> 입니다.</p>
							<div class="btn_area mt50-30">
								<a href="loginForm" class="el_btn frm_btn blue">확인</a> <!-- 로그인 페이지로 이동 -->
							</div>
						</div>
					</article>
					<!-- //아이디 찾기 결과 -->

		...
		<div id="container" class="ly_container"> 
			...
			<main id="contents" class="ly_contents">
						...
						<c:if test="${mainsildeList.use_yn == 'N'}">
							...
							<td>
								<c:if test="${mainsildeList.img1 != null && mainsildeList.img1 != ''}">
									<a href="eMainSlideWrite?num=${mainsildeList.num }"><img src="/resources/common/images/upload/main_banner/${mainsildeList.img1 }" alt="" width="100" height="100"></a>
								</c:if>
								<c:if test="${mainsildeList.img1 == null || mainsildeList.img1 == ''}">
									<a href="eMainSlideWrite?num=${mainsildeList.num }"><img src="/resources/common/admin/images/common/no_img.jpg" alt="" class="no_img" width="100" height="100"></a> <!-- 대체이미지 -->
								</c:if>
							</td>
							<td style="text-align: left;"><a href="eMainSlideWrite?num=${mainsildeList.num }">${mainsildeList.title}</a></td>
				...
				<div class="pagination mt20">
					...
					<c:if test="${maxPage > 0}">
					<a href="eMainSlideList?page=1" class="page_link ico first"><span class="blind">처음</span></a> <!-- 비활성화시 disabled 추가 -->
					</c:if>
					
					<!-- 이전 블럭으로 이동 -->
					<c:if test="${startPage gt 1 }">
                       	<a href="eMainSlideList?page=${startPage-1}" class="page_link ico prev"><span class="blind">이전</span></a> <!-- 비활성화시 disabled 추가 -->
                    </c:if>
                    ...
                    <c:forEach var="p" begin="${startPage}" end="${endPage}" step="1">
                      ...
                      <c:if test="${p ne currentPage }">
                      	<c:url var="eMainSlideList" value="eMainSlideList">
					...
					<a href="eMainSlideList?page=${endPage+1}" class="page_link ico next"><span class="blind">다음</span></a>
                    </c:if>
                    ...
                    <c:if test="${maxPage > 0}">
					<a href="eMainSlideList?page=${maxPage}" class="page_link ico last"><span class="blind">마지막</span></a>
					</c:if>
				</div>
				<!-- // pagination -->
				</c:if>
				<div class="btn_area mt40">
					<a href="eMainSlideWrite" class="el_btn md line">등록</a>
				</div>

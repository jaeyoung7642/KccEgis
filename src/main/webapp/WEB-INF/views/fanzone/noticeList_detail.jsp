				...
				<div class="ly_inner md">
					...
					<div class="board_view_header">
						...
						<div class="bbs_info_wrap md">
							<span class="bbs_info date">${noticeDetail.reg_date}</span>
					...
					<div class="board_view_content">
						<div class="inner">
							...
							<div class="btn_area mt50-30">
								<a href="noticeList?page=${listpage }&keyWord=${keyWord}" class="el_btn frm_btn gray">목록</a>
							</div>
						</div>
					</div>
					<!-- //board content -->
								...
								<table>
									...
									<tbody>
										...
										<tr>
											...
											<td class="tit">
												<div class="tit_inner">
													<a href="noticeListDetail?num=${nextDetail.num}" class="tit_link txt_line1-2">${nextDetail.subject }</a>
										...
										<tr>
											...
											<td class="tit">
												<div class="tit_inner">
													<a href="noticeListDetail?num=${prevDetail.num}" class="tit_link txt_line1-2">${prevDetail.subject }</a>

				...
				<div class="ly_inner md">
					...
					<article class="mt40-30">
						...
						<div class="pagination xm_hide">
							...
							<a href="noticeList?page=${endPage2+1}&keyWord=${keyWord}" class="page_link ico next"><span class="blind">다음</span></a>
		                    </c:if>
		                    ...
		                    <c:if test="${maxPage2 > 0}">
							<a href="noticeList?page=${maxPage2}&keyWord=${keyWord}" class="page_link ico last"><span class="blind">마지막</span></a>
							</c:if>
						</div>
						<!-- // pagination -->
						<!-- pagination -->

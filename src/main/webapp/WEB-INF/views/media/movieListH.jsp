				...
				<div class="ly_inner md">
						...
						<input type="hidden" name="otype" value="${otype}">
							...
							<div class="tags bl_tag_list">
								<c:forEach items="${searchKeywordList}" var="searchKeywordList">
									<a href="movieListH?keyWord=${searchKeywordList.search_keyword}" class="tag"><span>#${searchKeywordList.search_keyword}</span></a>
								</c:forEach>
							</div>
						</form>
					...
					<article class="board_latest_video mt40-30">
						...
						<div class="content">
							...
							<div class="btns btn_area mo_full">
								<a href="scheduleResult?season_code=${topMovieSchedule.season_code}&game_code=${topMovieSchedule.game_code}&game_no=${topMovieSchedule.game_no}" class="el_btn btn2 blue pmax170">
									<span class="el_ico ico_vs_w"></span> 경기 결과 보기
								</a>
								<a href="photoHDetail?game_date=${topMovieSchedule.game_date }" class="el_btn btn2 blue pmax170">

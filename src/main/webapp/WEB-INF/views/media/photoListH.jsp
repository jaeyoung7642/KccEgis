			...
			<section class="section">
				<div class="ly_inner md">
					...
					<article class="search_box type2 mb0">
						<form action="photoListH" class="search_box_form grid" id="searchForm">
							...
							<div class="row row1">
								...
								<a href="photoListH" class="el_btn refresh p_hide" aria-label="새로고침" ><span class="p_hide">새로고침</span></a>
							</div>
							<div class="row row2">
								<div class="col grow">
								...
								<div class="col m_flex">
									...
									<a href="photoListH" class="el_btn refresh p_show" aria-label="새로고침"></a>
								</div>
							</div>
					...
					<article class="mt50">
						...
						<div class="board_header">
							<div class="bbs_cate_list">
								<a href="photoListH?keyWord=${keyWord}&season=${season}&sdate=${sdate}&edate=${edate}&round=${round}&game=${game}&player=${player}&part=photo&otype=${otype}" class="cate <c:if test="${part =='photo'}">active</c:if>">24-25시즌이후</a>
								<a href="photoListH?keyWord=${keyWord}&season=${season}&sdate=${sdate}&edate=${edate}&round=${round}&game=${game}&player=${player}&part=gallery&otype=${otype}" class="cate <c:if test="${part =='gallery'}">active</c:if>">23-24시즌 이전</a>
							</div>

							<div class="bbs_sort_list">
								<a href="photoListH?keyWord=${keyWord}&season=${season}&sdate=${sdate}&edate=${edate}&round=${round}&game=${game}&player=${player}&part=${part}&otype=num" class="sort <c:if test="${otype =='num'}">active</c:if>">최신순</a>
								<a href="photoListH?keyWord=${keyWord}&season=${season}&sdate=${sdate}&edate=${edate}&round=${round}&game=${game}&player=${player}&part=${part}&otype=visited" class="sort <c:if test="${otype =='visited'}">active</c:if>">조회순</a>
							</div>
						</div>
						<!-- //board header -->
						...
						<c:forEach items="${photoList}" var="photoList">	
							<li class="item">
								<a href="photoListHDetail?num=${photoList.num}&listpage=${currentPage}&keyWord=${keyWord}&season=${season}&sdate=${sdate}&edate=${edate}&round=${round}&game=${game}&player=${player}&part=${part}&otype=${otype}" class="bbs_box">
					...
					<a href="photoListH?page=1&keyWord=${keyWord}&season=${season}&sdate=${sdate}&edate=${edate}&round=${round}&game=${game}&player=${player}&part=${part}&otype=${otype}" class="page_link ico first"><span class="blind">처음</span></a> <!-- 비활성화시 disabled 추가 -->
					</c:if>
					
					<!-- 이전 블럭으로 이동 -->
					<c:if test="${startPage2 gt 1 }">
                       	<a href="photoListH?page=${startPage2-1}&keyWord=${keyWord}&season=${season}&sdate=${sdate}&edate=${edate}&round=${round}&game=${game}&player=${player}&part=${part}&otype=${otype}" class="page_link ico prev"><span class="blind">이전</span></a> <!-- 비활성화시 disabled 추가 -->
                    </c:if>
                    ...
                    <c:forEach var="p" begin="${startPage2}" end="${endPage2}" step="1">
                      ...
                      <c:if test="${p ne currentPage }">
                      	<c:url var="photoListH" value="photoListH?keyWord=${keyWord}&season=${season}&sdate=${sdate}&edate=${edate}&round=${round}&game=${game}&player=${player}&part=${part}&otype=${otype}">
					...
					<a href="photoListH?page=${endPage+1}&keyWord=${keyWord}&season=${season}&sdate=${sdate}&edate=${edate}&round=${round}&game=${game}&player=${player}&part=${part}&otype=${otype}" class="page_link ico next"><span class="blind">다음</span></a>
                    </c:if>
                    ...
                    <c:if test="${maxPage2 > 0}">
					<a href="photoListH?page=${maxPage}&keyWord=${keyWord}&season=${season}&sdate=${sdate}&edate=${edate}&round=${round}&game=${game}&player=${player}&part=${part}&otype=${otype}" class="page_link ico last"><span class="blind">마지막</span></a>
					</c:if>
				</div>
				<!-- // pagination -->
						<!-- pagination -->
					...
					<c:if test="${startPage gt 1 }">
                       	<a href="photoListH?page=${startPage-1}&keyWord=${keyWord}&season=${season}&sdate=${sdate}&edate=${edate}&round=${round}&game=${game}&player=${player}&part=${part}&otype=${otype}" class="page_link ico prev"><span class="blind">이전</span></a> <!-- 비활성화시 disabled 추가 -->
                    </c:if>

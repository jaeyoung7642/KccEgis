			...
			<section class="section">
				<div class="ly_inner md">
					...
					<c:if test="${startPage2 gt 1 }">
                       	<a href="photoListH?page=${startPage2-1}&keyWord=${keyWord}&sdate=${sdate}&edate=${edate}&round=${round}&game=${game}&player=${player}&part=${part}&otype=${otype}" class="page_link ico prev"><span class="blind">이전</span></a> <!-- 비활성화시 disabled 추가 -->
                    </c:if>

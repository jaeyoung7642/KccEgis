		...
		<main id="container" class="ly_container media">
			...
			<div class="snb_3dth_area">
				<nav class="snb_3dth snb_list menu_slider">
					<div class="swiper-wrapper">
						<a href="photoListH" class="swiper-slide snb_link"><span>경기 사진</span></a> <!-- 해당페이지에 current 추가 -->
						<a href="photoListE" class="swiper-slide snb_link current"><span>이벤트 사진</span></a>
					</div>
				</nav>
			</div>
				...
				<div class="ly_inner md">
					...
					<div class="board_view_header">
						...
						<div class="bbs_info_wrap md">
							<span class="bbs_info date">${photoDetail.reg_date}</span>
					...
					<div class="board_view_content">
						...
						<!-- detail -->
						<c:if test="${detailPart=='gallery'}">
						<article class="board_view_detail">${photoDetail.content}</article>
						</c:if>
						...
						<div class="inner">
							<c:if test="${photoDetailSchedule != null }">
							...
							<div class="btn_area mt50-30">
								<a href="photoListE?page=${listpage}&keyWord=${keyWord}&season=${season}&sdate=${sdate}&edate=${edate}&round=${round}&game=${game}&player=${player}&part=${part}&otype=${otype}" class="el_btn frm_btn gray">목록</a>
							</div>
						</div>
					</div>
					<!-- //board content -->
						...
						<div class="slider group board_nav_slider" data-view="[5,4]" data-space="[12,12]" data-delay="400">
							<div class="swiper-wrapper">
								...
								<div class="swiper-slide">
									<a href="photoListEDetail?num=${footMovieList.num}" class="nav_link thumb_hover type2">
				                		<figure class="el_thumb rds el_img media">
										<c:if test="${footMovieList.img1 != null && footMovieList.img1 != ''}">
											<img src="/resources/common/images/upload/gallery/${footMovieList.img1 }" alt="" >
										</c:if>
										<c:if test="${footMovieList.img1 == null || footMovieList.img1 == ''}">

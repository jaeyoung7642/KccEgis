					...
					<div class="board_view_content">
						...
						<div class="inner">
							...
							<div class="btn_area mt50-30">
								<a href="photoListH?page=${listpage}&keyWord=${keyWord}&sdate=${sdate}&edate=${edate}&round=${round}&game=${game}&player=${player}&part=${part}&otype=${otype}" class="el_btn frm_btn gray">목록</a>
							</div>
						</div>
					</div>
					<!-- //board content -->

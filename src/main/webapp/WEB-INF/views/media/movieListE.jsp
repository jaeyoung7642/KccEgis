			...
			<section class="section">
				<div class="ly_inner md">
					...
					<article class="search_box type2 mb0">
						<form action="movieListE" class="search_box_form grid">
						...
						<input type="hidden" name="otype" value="${otype}">
							<div class="row row1">
								...
								<a href="movieListE" class="el_btn refresh" aria-label="새로고침"><span class="p_hide">새로고침</span></a>
							</div>
							<div class="row row2">
								<div class="col grow">
					...
					<article class="mt50">
						...
						<div class="board_header">
							<div class="bbs_cate_list">
								<a href="movieListE?keyWord=${keyWord}&sdate=${sdate}&edate=${edate}&round=${round}&game=${game}&player=${player}&otype=${otype}" class="cate <c:if test="${wtype =='all'}">active</c:if>">전체</a>
								<a href="movieListE?keyWord=${keyWord}&sdate=${sdate}&edate=${edate}&round=${round}&game=${game}&player=${player}&wtype=U&otype=${otype}" class="cate <c:if test="${wtype =='U'}">active</c:if>">영상</a>
								<a href="movieListE?keyWord=${keyWord}&sdate=${sdate}&edate=${edate}&round=${round}&game=${game}&player=${player}&wtype=S&otype=${otype}" class="cate <c:if test="${wtype =='S'}">active</c:if>">숏츠</a>
							</div>

							<div class="bbs_sort_list">
								<a href="movieListE?keyWord=${keyWord}&sdate=${sdate}&edate=${edate}&round=${round}&game=${game}&player=${player}&wtype=${wtype}&otype=num" class="sort <c:if test="${otype =='num'}">active</c:if>">최신순</a>
								<a href="movieListE?keyWord=${keyWord}&sdate=${sdate}&edate=${edate}&round=${round}&game=${game}&player=${player}&wtype=${wtype}&otype=visited" class="sort <c:if test="${otype =='visited'}">active</c:if>">조회순</a>
							</div>
						</div>
						<!-- //board header -->
						...
						<c:forEach items="${movieList}" var="movieList">
							<li class="item">
								<a href="movieListEDetail?num=${movieList.num}&listpage=${currentPage}&keyWord=${keyWord}&sdate=${sdate}&edate=${edate}&round=${round}&game=${game}&player=${player}&wtype=${wtype}&otype=${otype}" class="bbs_box">
								<c:choose>
					...
					<a href="movieListE?page=1&keyWord=${keyWord}&sdate=${sdate}&edate=${edate}&round=${round}&game=${game}&player=${player}&wtype=${wtype}&otype=${otype}" class="page_link ico first"><span class="blind">처음</span></a> <!-- 비활성화시 disabled 추가 -->
					</c:if>
					
					<!-- 이전 블럭으로 이동 -->
					<c:if test="${startPage2 gt 1 }">
                       	<a href="movieListE?page=${startPage2-1}&keyWord=${keyWord}&sdate=${sdate}&edate=${edate}&round=${round}&game=${game}&player=${player}&wtype=${wtype}&otype=${otype}" class="page_link ico prev"><span class="blind">이전</span></a> <!-- 비활성화시 disabled 추가 -->
                    </c:if>
                    ...
                    <c:forEach var="p" begin="${startPage2}" end="${endPage2}" step="1">
                      ...
                      <c:if test="${p ne currentPage }">
                      	<c:url var="movieListE" value="movieListE?keyWord=${keyWord}&sdate=${sdate}&edate=${edate}&round=${round}&game=${game}&player=${player}&wtype=${wtype}&otype=${otype}">
					...
					<a href="movieListE?page=${endPage2+1}&keyWord=${keyWord}&sdate=${sdate}&edate=${edate}&round=${round}&game=${game}&player=${player}&wtype=${wtype}&otype=${otype}" class="page_link ico next"><span class="blind">다음</span></a>
                    </c:if>
                    ...
                    <c:if test="${maxPage2 > 0}">
					<a href="movieListE?page=${maxPage2}&keyWord=${keyWord}&sdate=${sdate}&edate=${edate}&round=${round}&game=${game}&player=${player}&wtype=${wtype}&otype=${otype}" class="page_link ico last"><span class="blind">마지막</span></a>
					</c:if>
				</div>
				<!-- // pagination -->
						<!-- pagination -->
					...
					<c:if test="${startPage gt 1 }">
                       	<a href="movieListE?page=${startPage-1}&keyWord=${keyWord}&sdate=${sdate}&edate=${edate}&round=${round}&game=${game}&player=${player}&wtype=${wtype}&otype=${otype}" class="page_link ico prev"><span class="blind">이전</span></a> <!-- 비활성화시 disabled 추가 -->
                    </c:if>
					...
					<a href="movieListE?page=${endPage+1}&keyWord=${keyWord}&sdate=${sdate}&edate=${edate}&round=${round}&game=${game}&player=${player}&wtype=${wtype}&otype=${otype}" class="page_link ico next"><span class="blind">다음</span></a>
                    </c:if>
                    ...
                    <c:if test="${maxPage > 0}">
					<a href="movieListE?page=${maxPage}&keyWord=${keyWord}&sdate=${sdate}&edate=${edate}&round=${round}&game=${game}&player=${player}&wtype=${wtype}&otype=${otype}" class="page_link ico last"><span class="blind">마지막</span></a>
					</c:if>
				</div>
				<!-- // pagination -->
						</c:if>

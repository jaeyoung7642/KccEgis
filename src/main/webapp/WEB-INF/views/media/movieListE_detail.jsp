					...
					<div class="board_view_content">
						<div class="inner">
							...
							<div class="btn_area mt50-30">
								<a href="movieListE?page=${listpage}&keyWord=${keyWord}&season=${season}&sdate=${sdate}&edate=${edate}&round=${round}&game=${game}&player=${player}&wtype=${wtype}&otype=${otype}" class="el_btn frm_btn gray">목록</a>
							</div>
						</div>
					</div>
					<!-- //board content -->
						...
						<div class="slider group board_nav_slider" data-view="[5,4]" data-space="[12,12]" data-delay="400">
							<div class="swiper-wrapper">
								...
								<div class="swiper-slide">
									<a href="movieListEDetail?num=${footMovieList.num}" class="nav_link thumb_hover type2">
									<c:choose>
